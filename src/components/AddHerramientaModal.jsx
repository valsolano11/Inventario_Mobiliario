...
const AddHerramientaModal = ({ isOpen, onClose, herramienta }) => {
  ...
  useEffect(() => {
    ...
    const fetchEstados = async () => {
      try {
        const response = await api.get("/Estado/tipo/herramienta");
  ...
  const handleCreate = async () => {
    const {  nombre, codigo, marca, condicion, observaciones,  EstadoId, SubcategoriaId, UsuarioId } = formData;
    ...
    if (!codigo || !nombre || !condicion || !observaciones|| !marca || !EstadoId || !SubcategoriaId || !UsuarioId) {
