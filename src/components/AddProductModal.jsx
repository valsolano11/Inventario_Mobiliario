...
const AddProductModal = ({ isOpen, onClose, product }) => {
  ...
  const handleCreate = async () => {
    const {nombre, codigo, descripcion, cantidadEntrada,volumen, marca, UsuarioId, UnidadMedidaId, SubcategoriaId, EstadoId,} = formData;
    ...
    const volumennError = validateInput("volumen", volumen);
    ...
    if (nombreError) {
      setFormErrors((prevErrors) => ({
        ...
        marca: marcaError,
        volumen: volumennError,
      }));
      showToastError("Por favor, corrige los errores antes de agregar.");
      return;
    }
    if (!nombre  || !codigo || !descripcion || !cantidadEntrada || !marca || !volumen  || !UsuarioId || !UnidadMedidaId || !SubcategoriaId || !EstadoId) {
          ...
          <div className="w-full md:w-3/4">
            <div className="font-inter ml-1">
              <div className="space-y-1 md:space-y-0.5 text-left">
                ...
                <div className="flex flex-col">
                  <label className="mb-1 font-bold text-sm">Volumen*</label>
                  <input
                    className="bg-grisClaro text-sm rounded-lg px-2 h-8"
                    type="text"
                    name="volumen"
